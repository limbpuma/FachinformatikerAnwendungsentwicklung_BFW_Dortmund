	...
	public static void main ( String[] args )
	  {
	    ...
	    while ( spielerscore < ENDSTAND && computerscore < ENDSTAND )
	    {
	      ...
	      // Spieler wirft
	      System.out.print( "1 -> 11-seitiger Würfel | 2 -> 6-seitiger Würfel (1 oder 2)? " );
	      String wuerfeltyp = scan.nextLine();

	      if ( wuerfeltyp.equals( "1" ) )
	      {
	        spielerwurf = rand.nextInt( 11 ) + 2 ;
	        System.out.println("Sie werfen 1 Würfel und haben: " + spielerwurf );
	      }
	      else
	      {
	        spielerwurf = rand.nextInt( 6 ) + 1 + rand.nextInt( 6 ) + 1 ;
	        System.out.println("Sie werfen 2 Würfel und haben: " + spielerwurf );
	      }
